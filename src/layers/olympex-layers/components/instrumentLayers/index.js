...
class LayerGenerator {
    constructor() {
        this.instruments = ["trackEr2", "trackDc8", "crs", "cpl", "hiwrap", "nexradKATX", "nexradKRTX", "nexradKLGX"] // add new instrument name here
    ...
    generateLayer() {
        ...
        */
        ...
        return this.sortedUniqueDates([...this.dc8_dates, ...this.er2_dates, ...this.crs_dates, ...this.cpl_dates, ...this.hiwrap_dates, ...this.nexradKATX_dates, ...this.nexradKRTX_dates, ...this.nexradKLGX_dates]).map(date => ({
            date,

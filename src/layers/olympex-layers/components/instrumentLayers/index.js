import { flighttrack, crs, cpl, hiwrap, nexradKATX, nexradKRTX, nexradKLGX } from "./helpers";

class LayerGenerator {
    constructor() {
        this.instruments = ["trackEr2", "trackDc8", "crs", "cpl", "hiwrap", "nexradKATX"] // add new instrument name here
        ...
        this.nexradKATX_dates = ["2016-04-29", "2016-04-30", "2016-05-01"]
        this.nexradKRTX_dates = []
        this.nexradKLGX_dates = []
    ...
    generateLayer() {
        ...
        */
        ...
        return this.uniqueDates([...this.dc8_dates, ...this.er2_dates, ...this.crs_dates, ...this.cpl_dates, ...this.hiwrap_dates, ...this.nexradKATX_dates, ...this.nexradKRTX_dates, ...this.nexradKLGX_dates]).map(date => ({
            date,

    ...
    */
    ...
    if (aircraft == "er2") {
        return {
            ...
            czmlLocation: `${newFieldCampaignsBaseUrl}/Olympex/instrument-processed-data/nav_er2/olympex_naver2_IWG1_${date.replace(/-/g,'')}-1937.czml`,
        ...
        return {
            ...
            shortName: "flight14",
            displayName: "Flight Track",
            czmlLocation: `${newFieldCampaignsBaseUrl}/Olympex/instrument-processed-data/nav_dc8/olympex_navdc8_IWG1_${date.replace(/-/g,'')}-2138.czml`,

...
class LayerGenerator {
    constructor() {
        ...
        this.radiosonde_stcroix_dates = ["2021-08-20", "2021-08-26", "2021-08-28", "2021-09-01", "2021-09-04"];
    ...
    getInstrumentsItem(date, instrumentType, index) {
        ...
        */
        switch (instrumentType) {
            ...
            case "dropsonde":
                if (!this.dropsonde_dates.includes(date)) return null;
                return dropsonde(date, index);
            case "radiosonde":
                if (!this.radiosonde_stcroix_dates.includes(date)) return null;
